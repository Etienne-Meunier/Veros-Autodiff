# %%
# Worker for run_probe.py -- one jax.jit compile per process (same reasoning as
# report-mld-2/phase2_worker.py: avoids XLA cache/state bleeding between different n).
...
from common import spin_up_full_grid, make_diff_step, set_vars, rollout, mld_agg_function
