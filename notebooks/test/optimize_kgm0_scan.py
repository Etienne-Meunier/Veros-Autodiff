...
# notebooks/demonstration/gradient-computation.ipynb, for K_gm_0 :
#   - fix a target state by rolling out the ACC setup from a known K_gm_0
...
var_name = "K_gm_0"
pred_iter = 5
var_true = acc.state.variables.K_gm_0
...
out_path = f'{PRP}notebooks/figures/kgm0_scan_{datetime.now().strftime("%d%m%y")}.png'
