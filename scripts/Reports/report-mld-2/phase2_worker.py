# %%
# Worker for phase2_long_horizon.py -- one jax.jit compile per process, same reasoning
# as phase1_worker.py / report-mld-1/section1_worker.py.
...
from common import spin_up_phase2, make_diff_step, set_vars, rollout, mld_agg_function
...
g4d, step_jit = spin_up_phase2(warmup_steps=20)
